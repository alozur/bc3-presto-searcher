...
export type ImportDiagnostic = {code:string;sourceDisplayName:string;line:number;recordTag?:string;messageEs:string};
export type ImportSnapshot = {source:SourceKey;sourceDisplayName:string;items:readonly CatalogItem[];breakdowns:readonly {parent:ItemRef;line:BreakdownLine}[];diagnostics:readonly ImportDiagnostic[]};
